...
function CarCard({ car, index, onAction }: { car: Car; index: number; onAction: () => void }) {
    ...
    return (
        <motion.div
            ...
            className="bg-[#f8f9fa] rounded-[32px] border border-gray-100 overflow-hidden hover:shadow-2xl transition-all duration-500 group relative cursor-pointer"
        >
            <Link href={`/cars/${car.id}`}>
                ...
                <div className="p-8">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2 bg-[#0a111f] text-white px-5 py-3 rounded-2xl font-black text-[10px] group-hover:bg-primary transition-all shadow-xl shadow-zinc-200">
                            EXPLORE
